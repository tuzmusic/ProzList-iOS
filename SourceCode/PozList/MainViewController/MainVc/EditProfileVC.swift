...
class EditProfileVC: UIViewController, SideMenuItemContent,UIImagePickerControllerDelegate,UINavigationControllerDelegate,CustomToolBarDelegate {
  ...
  var toolBar : CustomToolBar = CustomToolBar.init(frame: CGRect(x: 0, y: 0, width: ScreenSize.WIDTH, height: 40),isSegment: true)
    ...
    var arr_edit = [["main":"Email","image":#imageLiteral(resourceName: "profile"),"sub":"","Place":"Enter Your Email"],["main":"City","image":#imageLiteral(resourceName: "profile"),"sub":"","Place":"Enter your city name"],["main":"Phone Number","image":#imageLiteral(resourceName: "profile"),"sub":"","Place":"Enter Your Phone Number"]]
