...
public class DTTextField: UITextField {
    ...
    fileprivate let paddingHeight:CGFloat                   = 0.0
    
    public var dtLayer:CALayer                              = CALayer()
    public var floatPlaceholderColor:UIColor                = UIColor.placeHolder()
    public var floatPlaceholderActiveColor:UIColor          = UIColor.placeHolder()
    ...
    public var errorFont = UIFont.init(name: FontName.RobotoRegular, size: 5.0){
        didSet{ invalidateIntrinsicContentSize() }
    }
    
    public var floatPlaceholderFont = UIFont.init(name: FontName.RobotoLight, size: 16.0){
        didSet{ invalidateIntrinsicContentSize() }
    }
    ...
    public var paddingYErrorLabel:CGFloat = 0.0{
        didSet{ invalidateIntrinsicContentSize() }
    }
    ...
    fileprivate func commonInit() {
        ...
        floatPlaceholderColor       = UIColor.placeHolder()
        floatPlaceholderActiveColor = UIColor.placeHolder()
