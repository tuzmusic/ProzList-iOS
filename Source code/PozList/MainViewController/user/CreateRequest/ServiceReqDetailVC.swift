...
class ServiceReqDetailVC: UIViewController,CustomToolBarDelegate {
	...
	// var arr_service_list = [["Service":"Plumbing","img":#imageLiteral(resourceName: "plumbing"),"isSelected":false],["Service":"Eletrical","img":#imageLiteral(resourceName: "electricle"),"isSelected":false],["Service":"HVAC","img":#imageLiteral(resourceName: "HVAC"),"isSelected":false],["Service":"Handyman","img":#imageLiteral(resourceName: "handyman"),"isSelected":false]]
	...
	func validateCreateReqData() -> Bool {
		...
		guard (text_view.text.count) != 0 else
		{
