...
public extension SwiftLuhn.CardType {
    ...
    func imageString() -> String {
        switch self {
        case .amex:
            return "imgCardAmex.png"
        case .visa:
            return "imgCardVisa.png"
        case .mastercard:
            return "imgCardMastercard.png"
        case .discover:
            return "imgCardDiscover.png"
        case .dinersClub:
            return "imgCardDiners_club.png"
        case .jcb:
            return "imgCardJcb.png"
        case .maestro:
            return "imgCardMaestro.png"
        default:
            return "imgCardUnknown.png"
        }
    }
    init?(string: String) {
